    ...
    public void run(ApplicationArguments args) throws Exception {
        if (personRepository.count() == 0) {
            List<Person> people = List.of(
                    ...
                    new Person(null, "Jennifer", "Smith", LocalDate.of(1960, 2, 1), "dummy@sample.com",new BigDecimal("60000"), null),
                    new Person(null, "Mark", "Jackson", LocalDate.of(1970, 3, 1), "dummy@sample.com",new BigDecimal("70000"), null),
                    new Person(null, "Vishnu", "McGuire", LocalDate.of(1997, 4, 1), "dummy@sample.com",new BigDecimal("80000"), null),
